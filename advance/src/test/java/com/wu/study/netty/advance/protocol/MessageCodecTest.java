...
import com.wu.study.netty.advance.protocol.div.SharableMessageCodec;
...
public class MessageCodecTest {
    public static void main(String[] args) throws Exception {
        ...
        SharableMessageCodec sharableMessageCodec = new SharableMessageCodec();
        ...
        channel.pipeline().addLast(sharableMessageCodec);
        // 测试编码与解码
